...
/* ---------------------------- OFFER CARDS ---------------------------- */
const offerCards = [
  { title: "Dubai summer flash deal", description: "Luxury stays, skyline views and guided city experiences with smooth Voibee support.", href: "/packages?destination=Dubai", ctaLabel: "Book Dubai", priceLabel: "From $499", image: "1512453979798-5ea266f8880c", country: "United Arab Emirates", countryCode: "AE", featured: true, sortOrder: 1, tags: ["dubai", "luxury"] },
  { title: "Bali honeymoon special", description: "Private villas, wellness experiences and island days curated for couples.", href: "/packages?destination=Bali", ctaLabel: "Explore Bali", priceLabel: "From $699", image: "1537996194471-e657df975ab4", country: "Indonesia", countryCode: "ID", featured: true, sortOrder: 2, tags: ["bali", "honeymoon"] },
  { title: "Kerala family holiday", description: "Backwaters, nature stays and relaxed family itineraries across Kerala.", href: "/packages?destination=Kerala", ctaLabel: "View Kerala", priceLabel: "From ₹14,999", image: "1602216056096-3b40cc0c9944", country: "India", countryCode: "IN", featured: false, sortOrder: 3, tags: ["kerala", "family"] },
  { title: "Varanasi festival escape", description: "A spiritual city break around river rituals, heritage walks and festive evenings.", href: "/packages?destination=Varanasi", ctaLabel: "See festival trips", priceLabel: "From ₹7,999", image: "1561361513-2d000a50f0dc", country: "India", countryCode: "IN", featured: false, sortOrder: 4, tags: ["festival", "spiritual"] },
];
