...
export const metadata: Metadata = {
  ...
  description:
    "Explore curated holiday packages, custom family packages, and honeymoon tours with Voibee Holidays. Book your perfect getaway to Kerala, beautiful Indian destinations, and international hotspots at the best prices.",
  keywords: [
    "holiday packages",
  ...
  openGraph: {
    ...
    title: "Voibee Holidays — Discover & Book Unforgettable Packages",
    description:
  ...
  return (
    <html lang="en" suppressHydrationWarning data-scroll-behavior="smooth" className={`${jakarta.variable} h-full`}>
      <body className="min-h-full bg-background text-foreground antialiased">
        <Script id="voibee-organization-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(organizationJsonLd) }} />
        <Analytics/>
